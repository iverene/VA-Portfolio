      ...
      <ol className="grid gap-px border border-[#e3e1dc] bg-[#e3e1dc] md:grid-cols-2">
        {services.map((s) => (
          <li key={s.n} className="flex flex-col bg-[#ffffff] p-6 md:p-8">
            <p className="text-xs font-medium uppercase tracking-[0.2em] text-[#6b6b6b]">{s.n}</p>
            ...
            <p className="mt-4 border-t border-[#e3e1dc] pt-3 text-xs uppercase tracking-[0.05em] text-[#1a1a1a]">{s.outcome}</p>
          </li>
        ))}
