...
export default function Home() {
  return (
    <Section id="home">
      ...
      >
        <div>
          <motion.p variants={rise} className="font-mono text-xs font-medium uppercase tracking-[0.2em] text-[#6b6b6b]">Administrative Virtual Assistant</motion.p>
          ...
          <motion.p variants={rise} className="mt-6 font-mono text-xs uppercase tracking-[0.15em] text-[#6b6b6b]">{CAPS.join(" · ")}</motion.p>
        ...
        <motion.figure variants={rise} className="border border-[#e3e1dc] bg-[#ffffff] p-4">
          ...
          <figcaption className="pt-4 font-mono text-[11px] uppercase tracking-[0.15em] text-[#6b6b6b]">Iverene Grace Causapin</figcaption>
        </motion.figure>
      </motion.div>
    </Section>
  );
