      ...
      <>
        <header className="border-b border-[#e3e1dc] bg-[#ffffff]">
          <div className="mx-auto flex max-w-[1280px] items-center justify-between px-6 py-4">
            ...
            <Link to="/#portfolio" className="text-xs uppercase tracking-[0.15em] text-[#1a1a1a] underline underline-offset-4">All Projects</Link>
          </div>
        </header>
      ...
      <main className="mx-auto w-full max-w-6xl px-6 py-12 md:py-16">
        <div className="max-w-3xl">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <p className="text-[11px] uppercase tracking-[0.15em] text-[#6b6b6b]">{project.type} · {project.status}</p>
          </div>
          ...
          <p className="mt-6 border-t border-[#e3e1dc] pt-4 text-[11px] uppercase tracking-[0.15em] text-[#6b6b6b]">
            Tools — {project.tools.join(" · ")}
          </p>

          {project.note && (
            <div className="mt-8 border border-dashed border-[#6b6b6b] p-5">
              <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-[#6b6b6b]">Source Note</p>
        ...
        <div className="mt-10 grid gap-10 md:grid-cols-[1fr_1.1fr] md:gap-0">
          <div className="space-y-10 md:pr-10">
            <section className="border-t border-[#e3e1dc] pt-8">
              <h2 className="text-xs font-medium uppercase tracking-[0.2em] text-[#6b6b6b]">Objective</h2>
              <p className="mt-3 leading-relaxed text-[#1a1a1a]">{project.objective}</p>
            </section>
            <section className="border-t border-[#e3e1dc] pt-8">
              <h2 className="text-xs font-medium uppercase tracking-[0.2em] text-[#6b6b6b]">Process</h2>
              <p className="mt-3 leading-relaxed text-[#1a1a1a]">{project.process}</p>
            </section>
          {project.formulas && project.formulas.length > 0 && (
            <section className="border-t border-[#e3e1dc] pt-8">
              <h2 className="text-xs font-medium uppercase tracking-[0.2em] text-[#6b6b6b]">Formulas & Concepts</h2>
            ...
            <section className="border-t border-[#e3e1dc] pt-8">
              <h2 className="text-xs font-medium uppercase tracking-[0.2em] text-[#6b6b6b]">Skills Demonstrated</h2>
              <div className="mt-4"><Metadata items={project.skills.map((s) => ["Skill", s])} /></div>
            </section>
            <section className="border-t border-[#e3e1dc] pt-8">
              <h2 className="text-xs font-medium uppercase tracking-[0.2em] text-[#6b6b6b]">Outcome</h2>
          ...
          <div className="md:border-l md:border-[#e3e1dc] md:pl-10">
            <div className="md:sticky md:top-24">
              <h2 className="text-xs font-medium uppercase tracking-[0.2em] text-[#6b6b6b]">Deliverables</h2>
        ...
        <nav aria-label="More projects" className="mt-14 grid gap-px border border-[#e3e1dc] bg-[#e3e1dc] sm:grid-cols-2">
          <Link to={`/project/${prev.id}`} className="bg-[#ffffff] p-4 md:p-5">
            <p className="text-[11px] uppercase tracking-[0.15em] text-[#6b6b6b]">← Previous</p>
          ...
          <Link to={`/project/${next.id}`} className="bg-[#ffffff] p-4 text-right md:p-5">
            <p className="text-[11px] uppercase tracking-[0.15em] text-[#6b6b6b]">Next →</p>
