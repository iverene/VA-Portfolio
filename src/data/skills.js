export const skillGroups = [
  ...
  { title: "Tools", items: ["Gmail", "Google Drive", "Google Docs", "Google Sheets", "Google Calendar", "Microsoft Excel", "Microsoft Word", "ClickUp", "Canva", "ChatGPT", "Gemini"] },
  { title: "AI-Enhanced Workflows", items: ["AI-Assisted Drafting & Editing", "Effective Prompting for Admin Tasks", "AI-Supported Research & Summaries", "Human Review for Accuracy & Privacy"] },
];
